...
namespace AdieLab.AffectCounsel.Editor
{
    public static class CounselingContentFactory
    {
        ...
        private static CaseSpec[] BuildSpecs() => new[]
        {
            ...
            new CaseSpec("adolescent-pressure-01", "청소년 학업 압박", "박서윤", "16세", "청소년·학교상담", "중급",
                "성적 하락과 부모 기대 사이에서 지치고 학교에서도 혼자 있으려 합니다.",
                "엄마는 제가 그냥 게을러진 거래요. 그런데 진짜 아무것도 하고 싶지 않아요.",
                "성인 권위에 대한 경계를 고려하고 존댓말을 강요하지 않으며 비밀보장의 한계를 투명하게 설명한다.", "직접 눈맞춤이 길면 부담을 느끼고 옆을 보며 생각한다. 재촉하지 않으면 짧게 재접촉한다.", .34f, .34f, "young-soft-korean", .64f, .56f,
                new[]{"상담의 비밀보장과 선택권을 설명한다.","학업 문제 뒤의 정서와 관계 경험을 탐색한다.","침묵을 실패로 보지 않고 기다린다."},
                new[]{"제 말을 바로 판단하지 않으니까 조금 편해요.","시험지를 받으면 심장이 빨리 뛰어요.","친구들이 물어볼까 봐 점심도 혼자 먹어요.","아빠가 실망할까 봐 성적표를 숨겼어요.","가끔 그냥 사라지고 싶다는 생각까지 들어요.","누구 한 명이라도 제 편이라고 느끼고 싶어요."},
